...
export default function Contact() {
  ...
  const labelClass = 'block text-[#6b6259] text-[10px] tracking-[0.2em] uppercase mb-2';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 pb-10 border-b border-[#2a2721]">
          ...
          <p className="text-[#6b6259] text-sm leading-relaxed max-w-xs lg:text-right">
            ...
            and are happy to discuss your property by phone if you prefer.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-10">
            <div className="space-y-8">
              <a href="tel:5551234567" className="flex items-start gap-5 group">
                ...
                <div>
                  <p className="text-[#6b6259] text-[10px] tracking-[0.2em] uppercase mb-1">Telephone</p>
                  <p className="text-[#f0ebe2] text-base group-hover:text-[#c5a264] transition-colors" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
                    (555) 123-4567
                  </p>
                </div>
              </a>

              <a href="mailto:hello@greenedgelandscaping.com" className="flex items-start gap-5 group">
                <div className="w-8 h-8 border border-[#2a2721] flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:border-[#c5a264]/50 transition-colors">
                  <Mail className="w-3.5 h-3.5 text-[#c5a264]" />
                </div>
                <div>
                  <p className="text-[#6b6259] text-[10px] tracking-[0.2em] uppercase mb-1">Email</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="text-[#6b6259] text-[10px] tracking-[0.2em] uppercase mb-1">Service Area</p>
                  <p className="text-[#9a8f82] text-sm">Franklin, Oakdale &amp; Westfield Counties</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="text-[#6b6259] text-[10px] tracking-[0.2em] uppercase mb-1">Office Hours</p>
                  <p className="text-[#9a8f82] text-sm">Monday – Friday, 8am – 5pm</p>
                  <p className="text-[#6b6259] text-xs mt-0.5">Saturday by appointment</p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-[#2a2721] pt-8">
              <p className="text-[#6b6259] text-xs leading-relaxed">
                We accept a limited number of new clients each season.
                Early enquiries are encouraged for spring and summer projects.
              </p>
            </div>
          </div>
            ...
            {submitted ? (
              <div className="py-16 border-t border-[#2a2721]">
                ...
                <p className="text-[#9a8f82] text-sm leading-relaxed max-w-sm">
                  Thank you, {form.name.split(' ')[0]}. We will review your enquiry
                  and be in touch within one business day to arrange a conversation.
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-8 border-t border-[#2a2721] pt-1">
                ...
                <div>
                  <label htmlFor="message" className={labelClass}>Tell Us About Your Property</label>
                  <textarea
                    id="message"
                    name="message"
                    rows={4}
